...
**Tests**: The examples below include test tasks. Tests are REQUIRED whenever the
constitution or feature specification mandates them. For CommercialScripting, generated
tasks MUST include acceptance coverage for sign-in, grounded generation, history
persistence, search by user ID, session ID, and generation ID, audit traceability, and
documentation-validation work for Azure OpenAI, LangChain when proposed, Azure AI Search,
Entra, and Azure SQL.
...
### Tests for User Story 1 (REQUIRED when constitution or spec demands them) ⚠️
...
### Tests for User Story 2 (REQUIRED when constitution or spec demands them) ⚠️
...
### Tests for User Story 3 (REQUIRED when constitution or spec demands them) ⚠️
...
- [ ] TXXX Re-run documentation-validation checkpoints against Azure OpenAI, LangChain when proposed, Azure AI Search, Entra, and Azure SQL
...
- Tests required by the constitution or spec MUST be written and FAIL before implementation
